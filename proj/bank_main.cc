...
int main(){
  ...
  cout<<"Linked List: Milliseconds elapsed for appending an extra element to " << originalSize << " elements: "<<appendTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for finding an element at " << originalSize << "/2 index: "<<findTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for transferring money from " << originalSize << "/2 index to " << originalSize<< "/2 + 1 index: "<<transferTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for getting balance at " << originalSize << "/2 index: "<<balanceTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for depositing money at " << originalSize << "/2 index: "<<depositTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for withdrawing money at " << originalSize << "/2 index: "<<withdrawTime<<endl;
  cout<<"Linked List: Milliseconds elapsed for deleting an element at " << originalSize << "/2 index: "<<deleteTime<<endl;
